...
/**
 * Script that creates a Chord network with the specified number of nodes.
 * This is good for testing how the network gets created and whether it's correct.
 * @author dmac
 *
 */
public class GenerateMultiNodeNetwork {
	
	public static void main(String[] args) throws AlreadyBoundException, IOException {
        if (args.length != 3) {
            Log.err("Usage: GenerateMultiNodeNetwork <port> <m> <node count>");
        } else {
